...
function logic() {
    let btnPlusOrMinus = [...document.querySelectorAll('.main__product-btn')],
        ...
        modalView = document.querySelector('.view'),
        modalViewClose = document.querySelector('.close'),
        modalViewImg = document.querySelector('.view-img')
    ...
    productInfo.forEach((el) => {
        el.addEventListener('dblclick', function () {
            let parentId = el.firstElementChild.src
            modalViewImg.src = parentId
            modalView.classList.add('active')
        })
    })

    modalViewClose.addEventListener('click', () => modalView.classList.remove('active'))
